Config = {
    ...
    inv = "ps", -- ox, qb, qs, ps, codem
    target = "ox", -- ox, qb
    orderWith3dText = true, -- INSTALL | https://github.com/erik-sn/fivem-3d-text
    ...
    jobs = {
        ['ambulance'] = { -- Job Name
            ...
            toggleNPCButton = vector3(0, 0, 0), -- adds a zone at these coords to stop NPCs spawning(keep at 0,0,0 if you want it disabled)
            items = {
